...
def calculate_chi2r(R,dof):
    """
    calculate reduced chisquare value, and corresponding p-value
    """
    chi2 = np.sum(R**2)
    chi2r = chi2/dof
...
def trunc(q,I,dI,q_ref):
    """
    truncated input data to a reference q, q_ref
    """
...
def fit_scale_offset(q_t,I_t,dI_t,q_ref,I_ref):
    """
    fit I_interp to (q_t,I_t,dI_t) using a scale and an offset
    """
...
def smooth(x,n,type):
    """
    smooth a function, linearly around midpoint
    """
