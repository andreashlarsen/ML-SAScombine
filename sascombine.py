...
try: 
    ...
    print("ERROR: SAScombine tried to import python package sys - is it correctly installed?\n")
    import sys
try:
    import argparse
except:
    print("ERROR: SAScombine tried to import python package argparse - is it correctly installed?\n")
    import argparse
try:
    import numpy as np
except:
    print("ERROR: SAScombine tried to import python package numpy - is it correctly installed?\n")
    import numpy as np
try:
    import os
except:
    print("ERROR: SAScombine tried to import python package os - is it correctly installed?\n")
    import os
try:  
    import shutil
except:
    print("ERROR: SAScombine tried to import python package shutil - is it correctly installed?\n")
    import shutil
try: 
    import matplotlib.pyplot as plt
except:
    print("## WARNING: SAScombine tried to import python package matplotlib - is it correctly installed?\n")
    import matplotlib.pyplot as plt
try:
    from math import ceil
except:
    print("ERROR: SAScombine tried to import python package ceil from math - is it correctly installed?\n")
    from math import ceil
try:
    import time
except:
    print("ERROR: SAScombine tried to import python package time - is it correctly installed?\n")   
    import time
try:
    from sascombine_functions import *
except:
    print("ERROR: SAScombine tried to import functions from files sascombine_functions.py")
    print("this file should be in the same directory as sascombine.py\n")
    from sascombine_functions import *
...
if __name__ == "__main__":
    ...
    input_string = f"{script_name} {' '.join(arguments)}"
    ...
    ## welcome message
    printt('#########################################')
    printt('RUNNING sascombine.py, version %s \nfor instructions: python sascombine.py -h' % version)
    ...
    for ref_data in ref_data_list:
        ...
        if not args.no_conv:
            if STOP_NEXT:
                ...
                printt('#########################################')
                printt('sascombine finished successfully')
    ...
    end_time =  time.time() - t_start   
    printt('#########################################')
    printt('sascombine.py finished successfully')
    printt('output sent to folder %s' % merge_dir)
    printt("run time: %1.2f" % end_time)
    printt('#########################################')
    f_out.close()
